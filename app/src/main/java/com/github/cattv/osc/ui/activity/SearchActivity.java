...
import com.github.cattv.osc.bean.AbsXml;
import com.github.cattv.osc.bean.Movie;
import com.github.cattv.osc.bean.SourceBean;
import com.github.cattv.osc.event.RefreshEvent;
import com.github.cattv.osc.event.ServerEvent;
import com.github.cattv.osc.server.ControlManager;
import com.github.cattv.osc.ui.adapter.PinyinAdapter;
import com.github.cattv.osc.ui.adapter.SearchAdapter;
import com.github.cattv.osc.ui.adapter.SearchRecordAdapter;
import com.github.cattv.osc.ui.dialog.RemoteDialog;
import com.github.cattv.osc.ui.tv.QRCodeGen;
import com.github.cattv.osc.ui.tv.widget.SearchKeyboard;
...
public class SearchActivity extends BaseActivity {
    ...
    private TvRecyclerView mGridViewSearchRecord;
...
//        keyboard = findViewById(R.id.keyBoardRoot);
        ...
        mGridViewSearchRecord = findViewById(R.id.mGridViewSearchRecord);
        ...
        wordAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                search(wordAdapter.getItem(position),false);
            }
        });
...
//            }
//        });
        findViewById(R.id.tvRemotSearch).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.tvClearRecord).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                searchRecord.clear();
        ...
        searchRecordAdapter = new SearchRecordAdapter();
        searchRecordAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                search(searchRecord.get(position),true);
            }
        });
        searchRecordAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            @Override
        ...
        mGridViewSearchRecord.setAdapter(searchRecordAdapter);
        mGridViewSearchRecord.setLayoutManager(new GridLayoutManager(this.mContext, 2));
...
//    }
    private void initData() {
        ...
        searchRecordAdapter.setNewData(searchRecord);
//        refreshQRCode();
