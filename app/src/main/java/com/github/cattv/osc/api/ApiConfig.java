package com.github.cattv.osc.api;
...
public class ApiConfig {
    ...
    public void loadConfig(boolean useCache, LoadConfigCallback callback, Activity activity) {
        ...
        String apiUrl = Hawk.get(HawkConfig.API_URL, HawkConfig.DEFAUT_API_URL);
        ...
        if (useCache && cache.exists()) {
            Log.i("guoguo", "loadConfig  useCache=" + useCache + " cache.exists()=" + cache.exists());
            try {
                if (param == 2) {
                    parseJson(apiUrl, cache);
                } else {
                    pareLocalJson(apiUrl);
                }
                callback.success();
                return;
            } catch (Throwable th) {
        ...
        Log.i("guoguo", "load config onLine  apiFix=" + apiFix);
...
//        https://raw.liucn.cc/box/sub/jar/A235.jar;md5;7C7281A78781BD352DFE9CA3E3293999
    ...
    private void pareLocalJson(String apiUrl) throws Throwable {
        StringBuilder sb = new StringBuilder();
        InputStream inputStream = null;
        App app = App.getInstance();

        inputStream = app.getResources().getAssets().open("xpg.json");
