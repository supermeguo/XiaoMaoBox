package com.github.cattv.osc.ui.fragment;
...
import com.github.cattv.osc.bean.IJKCode;
import com.github.cattv.osc.bean.SourceBean;
import com.github.cattv.osc.bean.VersionBean;
import com.github.cattv.osc.callback.RequestCallback;
import com.github.cattv.osc.ui.activity.HomeActivity;
import com.github.cattv.osc.ui.activity.SettingActivity;
import com.github.cattv.osc.ui.adapter.SelectDialogAdapter;
import com.github.cattv.osc.ui.dialog.AboutDialog;
import com.github.cattv.osc.ui.dialog.ApiDialog;
import com.github.cattv.osc.ui.dialog.BackupDialog;
import com.github.cattv.osc.ui.dialog.CheckVersionDialog;
import com.github.cattv.osc.ui.dialog.SelectDialog;
import com.github.cattv.osc.ui.dialog.XWalkInitDialog;
import com.github.cattv.osc.util.FastClickCheckUtil;
...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    protected void init() {
        ...
        ((TextView) findViewById(R.id.tvVersionName)).setText("v "+ com.github.cattv.osc.BuildConfig.VERSION_NAME);
        LinearLayout llCheckVersion = findViewById(R.id.llCheckVersion);
        tvMediaCodec.setText(Hawk.get(HawkConfig.IJK_CODEC, ""));
        tvDebugOpen.setText(Hawk.get(HawkConfig.DEBUG_OPEN, false) ? "已打开" : "已关闭");
        tvParseWebView.setText(Hawk.get(HawkConfig.PARSE_WEBVIEW, true) ? "系统自带" : "XWalkView");
        tvApi.setText(Hawk.get(HawkConfig.API_URL, HawkConfig.DEFAUT_API_URL));
            ...
            public void onClick(View v) {
                ...
                dialog.setOnListener(new ApiDialog.OnListener() {
                    ...
                    public void onchange(String api) {
                        ...
                        tvApi.setText(api);
                        SharedPreferencesUtils.getParam(SharedPreferencesUtils.CONFIG_MODEL, 2);
                    }
                });
    ...
    private void checkVersion() {
        ...
        XMLServiceUtils.getXMLData(VERSION_URL_PATH, new RequestCallback() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (cludVersionCode > versionCode) {
                            CheckVersionDialog checkVersionDialog = new CheckVersionDialog(mActivity);
            ...
            public void onError(String errorMSG) {
                Toast.makeText(getActivity(), "检查版本失败", Toast.LENGTH_LONG).show();
            }
        });
    }
