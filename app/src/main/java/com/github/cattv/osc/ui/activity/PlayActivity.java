...
import com.github.cattv.osc.player.controller.VodController;
import com.github.cattv.osc.player.thirdparty.MXPlayer;
import com.github.cattv.osc.player.thirdparty.ReexPlayer;
...
import com.github.cattv.osc.util.LOG;
import com.github.cattv.osc.util.MD5;
import com.github.cattv.osc.util.PlayerHelper;
import com.github.cattv.osc.util.XWalkUtils;
import com.github.cattv.osc.util.thunder.Thunder;
...
public class PlayActivity extends BaseActivity {
    ...
    public void play() {
        ...
        if (vs!=null&& BuildConfig.DEBUG) {
            Log.i("guoguo", "play url=" + vs.url);
        }
        playUrl(null, null);
