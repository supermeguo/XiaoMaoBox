package com.github.cattv.osc.ui.activity;


import static com.github.cattv.osc.util.XMLServiceUtils.VERSION_URL_PATH;
...
import com.github.cattv.osc.api.ApiConfig;
import com.github.cattv.osc.base.BaseActivity;
import com.github.cattv.osc.base.BaseLazyFragment;
import com.github.cattv.osc.bean.AbsSortXml;
import com.github.cattv.osc.bean.MovieSort;
import com.github.cattv.osc.bean.VersionBean;
import com.github.cattv.osc.event.RefreshEvent;
import com.github.cattv.osc.server.ControlManager;
import com.github.cattv.osc.ui.adapter.HomePageAdapter;
import com.github.cattv.osc.ui.adapter.SortAdapter;
import com.github.cattv.osc.ui.dialog.CheckVersionDialog;
import com.github.cattv.osc.ui.dialog.TipDialog;
import com.github.cattv.osc.ui.fragment.GridFragment;
import com.github.cattv.osc.ui.fragment.UserFragment;
import com.github.cattv.osc.ui.tv.widget.DefaultTransformer;
import com.github.cattv.osc.ui.tv.widget.FixedSpeedScroller;
import com.github.cattv.osc.ui.tv.widget.NoScrollViewPager;
import com.github.cattv.osc.ui.tv.widget.ViewObj;
import com.github.cattv.osc.util.AppManager;
import com.github.cattv.osc.util.DefaultConfig;
import com.github.cattv.osc.util.HawkConfig;
import com.github.cattv.osc.callback.RequestCallback;
import com.github.cattv.osc.util.SharedPreferencesUtils;
import com.github.cattv.osc.util.XMLServiceUtils;
import com.github.cattv.osc.viewmodel.SourceViewModel;
...
public class HomeActivity extends BaseActivity {
    ...
    public String[] permissionStrings = new String[]{
            ...
            public void onSuccess(String result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        int localVersionCode = (int) SharedPreferencesUtils.getParam("cludVersionCode", 0);
                        int versionCode = com.github.cattv.osc.BuildConfig.VERSION_CODE;
                        ...
                        if (cludVersionCode > versionCode) {
                            ...
                            checkVersionDialog.setMyDialogCallback(new CheckVersionDialog.DialogCallback() {
                                ...
                                public void onCancel() {
                                    SharedPreferencesUtils.setParam("cludVersionCode", versionBean.getVersionCode());
                                }
    ...
    private void initView() {
        ...
        int param = (int) SharedPreferencesUtils.getParam(SharedPreferencesUtils.CONFIG_MODEL, 2);
        if (param == 1) {
            tvModel.setText("本地json");
        } else {
            tvModel.setText("订阅地址");
        }
            ...
            public void onItemClick(TvRecyclerView parent, View itemView, int position) {
                if (position == 0) {
                    ...
                    if (currentTimeMillis - lastTimeMillis < 500) {
                        ...
                        if (param == 1) {
                            tvModel.setText("订阅地址");
                            SharedPreferencesUtils.setParam(SharedPreferencesUtils.CONFIG_MODEL, 2);
                        } else {
                            SharedPreferencesUtils.setParam(SharedPreferencesUtils.CONFIG_MODEL, 1);
                            tvModel.setText("本地json");
                        }
                        Toast.makeText(mContext, "已切换加载模式,下次重启生效", Toast.LENGTH_SHORT).show();
                        jarInitOk = false;
                        dataInitOk = false;
                        initData();
                    }
    ...
    private void initData() {
        Log.i("guoguo", "dataInitOk=" + dataInitOk + " jarInitOk=" + jarInitOk);
    ...
    private void initViewPager(AbsSortXml absXml) {
        ...
        if (sortAdapter.getData().size() > 0) {
            Log.i("guoguo", "sortAdapter.getData().size() > 0");
            for (MovieSort.SortData data : sortAdapter.getData()) {
                if (data.id.equals("my0")) {
                    if (Hawk.get(HawkConfig.HOME_REC, 0) == 0 && absXml != null && absXml.videoList != null && absXml.videoList.size() > 0) {
