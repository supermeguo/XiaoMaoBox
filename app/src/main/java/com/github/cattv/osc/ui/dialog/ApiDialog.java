...
import com.github.cattv.osc.ui.adapter.ApiHistoryDialogAdapter;
...
public class ApiDialog extends BaseDialog {
    ...
    public ApiDialog(@NonNull @NotNull Context context) {
        ...
        inputApi.setText(Hawk.get(HawkConfig.API_URL, HawkConfig.DEFAUT_API_URL));
        ...
        findViewById(R.id.apiHistory).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (history.isEmpty())
                    return;
                String current = Hawk.get(HawkConfig.API_URL, HawkConfig.DEFAUT_API_URL);
                int idx = 0;
