...
import com.github.cattv.osc.ui.adapter.SettingMenuAdapter;
import com.github.cattv.osc.ui.adapter.SettingPageAdapter;
import com.github.cattv.osc.ui.fragment.ModelSettingFragment;
...
public class SettingActivity extends BaseActivity {
    ...
    private void initData() {
        currentApi = Hawk.get(HawkConfig.API_URL, HawkConfig.DEFAUT_API_URL);
    ...
    public void onBackPressed() {
        if ((homeSourceKey != null && !homeSourceKey.equals(Hawk.get(HawkConfig.HOME_API, ""))) ||
                !currentApi.equals(Hawk.get(HawkConfig.API_URL,  HawkConfig.DEFAUT_API_URL)) ||
                homeRec != Hawk.get(HawkConfig.HOME_REC, 0) ||
                dnsOpt != Hawk.get(HawkConfig.DOH_URL, 0)) {
            AppManager.getInstance().finishAllActivity();
            if (currentApi.equals(Hawk.get(HawkConfig.API_URL,  HawkConfig.DEFAUT_API_URL))) {
